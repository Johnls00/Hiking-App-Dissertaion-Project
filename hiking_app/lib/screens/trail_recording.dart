...
class _TrailRecordingScreenState extends State<TrailRecordingScreen> {
  ...
  @override
  void dispose() {
    // Cancel location tracking (fire and forget since dispose can't be async)
    cancelPositionTracking().catchError((error) {
      debugPrint('Error cancelling location tracking: $error');
    });
